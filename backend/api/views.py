...
from .models import User, Society, Event, University, Student, Buys, Hosts
from .serializers import UserSerializer, SocietySerializer, UniversitySerializer, EventModelSerializer,BuysModelSerializer, HostsModelSerializer, SocietyCreationSerializer, StudentSerializer, StudentCreationSerializer
