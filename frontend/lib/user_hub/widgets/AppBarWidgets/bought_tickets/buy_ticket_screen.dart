...
class BuyTicketScreen extends StatelessWidget {
  ...
  const BuyTicketScreen({Key? key, required this.id}) : super(key: key);
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                              child: Text(
                                                  'Date: ' +
                                                      "${DataP.collection[index].event.date}",
                                                  textAlign: TextAlign.left),
                                            ),
                                          ],
                                        )),
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                              child: Text(
                                                  'Time: ' +
                                                      "${DataP.collection[index].event.time}",
                                                  textAlign: TextAlign.left),
                                            ),
                                          ],
                                        )),
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                              child: Text(
                                                  'Venue: ' +
                                                      "${DataP.collection[index].event.venue}",
                                                  textAlign: TextAlign.left),
                                            ),
                                          ],
                                        )),
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                              child: Text(
                                                  'Description: ' +
                                                      "${DataP.collection[index].event.description}",
                                                  textAlign: TextAlign.left),
                                            ),
                                          ],
                                        )),
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                              child: Text(
                                                  'Price: ' +
                                                      "${DataP.collection[index].event.price}",
                                                  textAlign: TextAlign.left),
                                            ),
                                          ],
                                        )),
